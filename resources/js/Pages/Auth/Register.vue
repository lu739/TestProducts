...
async function submit() {
    ...
    try {
        const { data } = await axios.post(route('api.register'), {
        ...
        <div class="auth-card">
            ...
            <form class="auth-card__form" @submit.prevent="submit">
                <label class="auth-field">
                    ...
                    />
                    <span v-if="errors.name" class="auth-field__error">{{
                        errors.name[0]
                    }}</span>
                </label>
                <label class="auth-field">
                ...
                <label class="auth-field">
                    ...
                    <input
                        ...
                        class="auth-field__input"
                    />
                    <span class="auth-field__hint">
                        Не менее 12 символов, буквы верхнего и нижнего регистра, цифры и знаки.
                    </span>
                ...
                <label class="auth-field">
                    <span class="auth-field__label">Пароль ещё раз</span>
                    <input
            ...
            <p class="auth-card__footer">
                Уже есть аккаунт?
                <Link href="/login" class="auth-card__link">Вход</Link>
            </p>
        </div>
    </AppLayout>
</template>
